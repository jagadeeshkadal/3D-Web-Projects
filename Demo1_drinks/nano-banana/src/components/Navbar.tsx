...
import { Zap, Menu, ShoppingBag } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-8">
          {["Juices", "Our Story", "Health Benefits", "Shop"].map((item) => (
            <a key={item} href="#" className="text-[11px] font-black text-white/70 hover:text-white transition-colors uppercase tracking-[0.2em]">
              {item}
            </a>
          ))}
        </div>
